            ...
            <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={8} lg={12}>
                  ...
                  >
                    <UsersTable busqueda={buscador} users={usuarios.filter(user => user.role.S == "mbcor" || user.role == undefined)} filtro={filtro.filter(user => user.role.S == "mbcor" || user.role == undefined)} />
                  </Paper>
                </Grid>
              </Grid>
              <Copyright sx={{ pt: 4 }} />
